...
\hypertarget{index_autotoc_md4}{}\doxysection{A programról}\label{index_autotoc_md4}
\hypertarget{index_autotoc_md5}{}\doxysubsection{Osztályok, jelentésük, használatuk}\label{index_autotoc_md5}
\hypertarget{index_autotoc_md6}{}\doxysubsubsection{Vector osztály}\label{index_autotoc_md6}
Az általam definiált \mbox{\hyperlink{classVector}{Vector}} osztály egy kétdimenziós vektort valósít meg. Matematikai műveletek elvégzéséhez deiniáltam ezt az osztályt, ugyanis erre nincsen külön STL-\/beli előre definiált osztály. A programban mindenhol használom ezt az osztályt, ugyanis a szimulációnál a számítások túlnyomó része a vektoralgebra területéhez tartozik.\hypertarget{index_autotoc_md7}{}\doxysubsubsection{Basic\+Boid osztály}\label{index_autotoc_md7}
...
\end{DoxyItemize}\hypertarget{index_autotoc_md11}{}\doxysubsubsection{Separation\+Rule osztály}\label{index_autotoc_md11}
...
\end{DoxyItemize}\hypertarget{index_autotoc_md12}{}\doxysubsubsection{Cohesion\+Rule osztály}\label{index_autotoc_md12}
...
\item $ \vec{d} $\+: Az irányvektor (direction),
\item $ S $\+: Szabály erőssége (rule\+Strength).
\end{DoxyItemize}\hypertarget{index_autotoc_md13}{}\doxysubsubsection{Alignment\+Rule osztály}\label{index_autotoc_md13}
...
\end{DoxyItemize}\hypertarget{index_autotoc_md14}{}\doxysection{Memóriaszivárgás \char`\"{}problémák\char`\"{}}\label{index_autotoc_md14}
...
\end{DoxyItemize}\hypertarget{index_autotoc_md15}{}\doxysubsection{Memóriaszivárgáshoz kapcsolódóan}\label{index_autotoc_md15}
